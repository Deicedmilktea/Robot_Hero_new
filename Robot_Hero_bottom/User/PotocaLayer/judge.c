...
void Update_data()
{
    ...
    if (Flag_judge == 1) // 红色方
    {
        if (Judge_Hero.robot_hp.red_1_robot_HP != 0 && Judge_Hero.robot_hp.red_1_robot_HP != 600)
        {
            Flag_first = 2;
        }
    }
    ...
    {
        if (Judge_Hero.robot_hp.blue_1_robot_HP != 0 && Judge_Hero.robot_hp.blue_1_robot_HP != 600)
        {
            Flag_first = 2;
        }
    }
